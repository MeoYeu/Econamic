      ...
      <div className="row top">
        <div className="col-2">
          <ul>
            ...
            <li>
              <div className="card card-body">
                <h2>Kiểu thanh toán</h2>
                <p>
                  <strong>Kiểu trả:</strong> {order.paymentMethod}
                </p>
                {order.isPaid ? (
                  <MessageBox variant="success">
        ...
        <div className="col-1">
          <div className="card card-body">
            <ul>
              ...
              <li><button type='button' className='success ' onClick={handlerbackhome} >Xác nhận </button></li>
            </ul>
          </div>
        </div>
      </div>
